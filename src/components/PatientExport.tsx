...
const PatientExport = (props: any) => {
  ...
  const getPatients = async (): Promise<User[]> => {
    const response = await fetch(`https://nica-clinic-api.setout.academy//admin_api/all_patients`, {
      method: 'GET',
      headers: {
        Authorization: token
      }
  ...
  const searchPatients = async () => {
    fetch(`https://nica-clinic-api.setout.academy//admin_api/search_patients`, {
      method: 'POST',
      headers: {
        Authorization: token
      },
  ...
  const handleExportAllPatients = () => {
    fetch(`https://nica-clinic-api.setout.academy//admin_api/export`, {
      method: 'POST',
      headers: {
        Authorization: token
      }
  ...
  const handleExportSinglePatient = (patientId: string) => {
    fetch(`https://nica-clinic-api.setout.academy//admin_api/export_patient`, {
      method: 'POST',
      headers: {
        Authorization: token
      },
